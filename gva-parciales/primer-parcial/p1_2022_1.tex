...
\item Sean $A$ y $B$ puntos del plano tales que $\|B\|=2\|A\|$ y $\|A-B\|=\dfrac{5}{2}\|A\|$. Entonces se puede concluir que
...
\item $A\cdot B=\dfrac{-1}{64}\|A\|\|B\|$.
\item Ninguna de las anteriores.
\end{opciones}

\item Considere los puntos en la imagen y suponga que las líneas rectas se cortan ortogonalmente. Si $A=\vect{8}{4}$, y $D=\vect{-17}{4}$, hallar las coordenadas de $C$.
...
\draw[thick] ($(G)!-0.15!(C)$) -- ($(C)!-0.2!(G)$);
\draw[thick] ($(H)!-0.15!(B)$) -- ($(B)!-0.2!(H)$);
\draw[-{Latex},thin] (-4.3,0) -- (5,0) node[right]{$x$};
\draw[-{Latex},thin] (0,-2.3) -- (0,3.6) node[above]{$y$};
...
\item Considere las rectas $\mathcal{L}_{AB}$ y $\mathcal{L}_{CD}$, donde $A=\vect{-5}{0}, B=\vect{0}{5}, C=\vect{5}{0}, D=\vect{0}{-5}$. De las siguientes afirmaciones, seleccione todas aquellas que son verdaderas.
...
\item Considere los puntos $A=\vect{4}{1}$ y $B=\vect{3}{12}$. Si rotamos el rayo $R^{+}_{\overrightarrow{OA}}$ por un ángulo $\theta$, hasta hacerlo coincidir con el rayo $R^{+}_{\overrightarrow{OB}}$, entonces los valores de $\cos\theta$ y $\operatorname{sen}\theta$ son:

\item Considere el vector unitario $A=\vect{-1/2}{-\sqrt{3}/2}$. Otro vector unitario $B$ hace un ángulo de $60^\circ$ con el vector $A$ y es tal que la pareja $(A,B)$ está orientada positivamente. Sea $C=\vect{-2}{-2/\sqrt{3}}$. Los valores de $r$ y $s$ tales que $C=rA+sB$ son:
