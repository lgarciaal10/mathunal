...
\vspace{4pt}
\noindent Nombre: \underline{\hspace{6cm}}\hfill Grupo: \underline{\hspace{2cm}}\\[4pt]
...
$$A=\vect{2}{4},\ B=\vect{-2.00}{-4.00},\ C=\vect{1.00}{2.00},\ D=\vect{1.00}{-1.00}$$
tenemos que
...
\item Sea $\mathcal{L}$ la recta que pasa por los puntos $A=\vect{-2}{2}$ y $B=\vect{4}{-2}$, entonces:
...
\item Considere la circunferencia $\mathcal{C}$ con ecuación $(x-3)^2+(y-5)^2=3^2$.

\begin{opciones}
\item Sea $\mathcal{L}$ la recta tangente a $\mathcal{C}$ en el punto $P=\vect{6}{5}$. El vector director de $\mathcal{L}$ es $\vect{u}{1}$, con $u=$ \underline{\hspace{2cm}}.
