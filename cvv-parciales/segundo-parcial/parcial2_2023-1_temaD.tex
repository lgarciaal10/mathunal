...
\renewcommand{\examtitulo}{Cálculo en Varias Variables --- Segundo Parcial (Tema D)}
...
\begin{enumerate}
\item{} (10\,\%) Plantee una integral en coordenadas cilíndricas que permita calcular el volumen del sólido, en el primer octante, limitado por los paraboloides $z = x^2 + y^2 + 1$ y $z = 17 - x^2 - y^2$ (no la evalúe).

\vspace{2pt}
\noindent Respuesta: \underline{\phantom{XXXXXXXXXXXXXXXX}}\quad (Escriba claramente cada límite de integración.)

\item{} (20\,\%) Considere el sólido en $\mathbb{R}^3$ debajo de la esfera $x^2 + y^2 + z^2 = 4$ y encima del cono $z = \sqrt{x^2+y^2}$. Y suponga que la densidad en cada punto $(x,y,z)$ es igual a la distancia del punto al eje $z$.
\begin{itemize}
...
\item[(b)] (10\,\%) Escriba la misma integral del ítem (a) en coordenadas esféricas.
...
\[
\int_1^2 \int_0^{\ln x} f(x,y)\,dy\,dx
\]
...
\item{} (20\,\%) Encuentre el momento respecto al eje $x$, $M_x$, de la región del primer cuadrante limitada por $y = 0$, $y = \sqrt3\,x$ y $x^2 + y^2 = 4$, y cuya densidad en cada punto es $\rho(x,y) = \operatorname{sen}\!\left((x^2+y^2)^{3/2}\right)$.

\item{} (20\,\%) Determine el máximo y el mínimo de la función $f(x,y) = x^2 + 2y^2 - 4xy$ para los puntos $(x,y)$ que satisfacen $x^2 + 2y^2 = 1$.
